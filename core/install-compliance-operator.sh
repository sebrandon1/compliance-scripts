...
PINNED_OPERATOR_IMAGE="${RELATED_IMAGE_OPERATOR:-${IMAGE_REGISTRY}/compliance-operator:${CO_IMAGE_TAG}}"
PINNED_OPENSCAP_IMAGE="${RELATED_IMAGE_OPENSCAP:-${IMAGE_REGISTRY}/openscap-ocp:${CO_IMAGE_TAG}}"
