...
|-------|---------|-------------|------|
| `rhcos4-e8-worker-audit-rules-dac-modification-chmod` | E8 | Audit chmod syscalls | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_dac_actions) |
| `rhcos4-e8-worker-audit-rules-dac-modification-chown` | E8 | Audit chown syscalls | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_dac_actions) |
