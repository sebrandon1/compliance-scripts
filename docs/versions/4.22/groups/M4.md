...
| Check | Profile | Docs |
|-------|---------|------|
| `rhcos4-e8-worker-audit-rules-execution-chcon` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_execution_selinux_commands) |
| `rhcos4-e8-worker-audit-rules-execution-restorecon` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_execution_selinux_commands) |
| `rhcos4-e8-worker-audit-rules-execution-semanage` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_execution_selinux_commands) |
| `rhcos4-e8-worker-audit-rules-execution-setfiles` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_execution_selinux_commands) |
| `rhcos4-e8-worker-audit-rules-execution-setsebool` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_execution_selinux_commands) |
| `rhcos4-e8-worker-audit-rules-execution-seunshare` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_execution_selinux_commands) |
