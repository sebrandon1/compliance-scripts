...
|-------|---------|-------------|------|
| `rhcos4-e8-worker-sshd-disable-empty-passwords` | E8 | Disable SSH empty passwords (worker) | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/services/ssh/ssh_server/sshd_disable_empty_passwords) |
| `rhcos4-e8-master-sshd-disable-empty-passwords` | E8 | Disable SSH empty passwords (master) | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/services/ssh/ssh_server/sshd_disable_empty_passwords) |
