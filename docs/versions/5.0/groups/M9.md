...
> **Remediation required.** This group (1 checks) fails on vanilla RHCOS 10.2 and requires MachineConfig remediation. Verified on cnfdt16 (OCP 5.0, RHCOS 10.2) with compliance-operator v1.8.2.
...
| Check | Profile | Docs |
|-------|---------|------|
| `rhcos4-e8-worker-auditd-name-format` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/configure_auditd_data_retention/auditd_name_format) |
