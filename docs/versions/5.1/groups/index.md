---
layout: default
title: OCP 5.1 Remediation Groups
version: "5.1"
---

# OCP 5.1 Remediation Groups

[← Back to OCP 5.1 Compliance Status](../../5.1.html) | [View Summary](../remediations.html)
...
<div class="copy-box">
  <code id="url-h1">https://sebrandon1.github.io/compliance-scripts/versions/5.1/groups/H1.html</code>
  <button class="copy-btn" onclick="copyToClipboard('url-h1')" title="Copy to clipboard">📋</button>
</div>
<div class="copy-box">
  <code id="url-m1">https://sebrandon1.github.io/compliance-scripts/versions/5.1/groups/M1.html</code>
  <button class="copy-btn" onclick="copyToClipboard('url-m1')" title="Copy to clipboard">📋</button>
</div>

Example markdown for PR descriptions:
<div class="copy-box">
  <code id="example-md">This PR implements [H1: Crypto Policy](https://sebrandon1.github.io/compliance-scripts/versions/5.1/groups/H1.html) and [H2: PAM Empty Passwords](https://sebrandon1.github.io/compliance-scripts/versions/5.1/groups/H2.html).</code>
