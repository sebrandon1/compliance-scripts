...
> **No remediation needed on OCP 5.1+.** The default IngressController TLS profile in OCP 5.1 already meets CIS cipher suite requirements. Older OCP versions may require a custom `tlsSecurityProfile` configuration.
