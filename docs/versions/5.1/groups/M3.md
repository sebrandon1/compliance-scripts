...
> **Remediation required.** This group (2 checks) fails on vanilla RHCOS 10.2 and requires MachineConfig remediation. Verified on cnfdt16 (OCP 5.1, RHCOS 10.2) with compliance-operator v1.8.2.
