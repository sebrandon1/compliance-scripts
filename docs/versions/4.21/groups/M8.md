...
| Check | Profile | Docs |
|-------|---------|------|
| `rhcos4-e8-worker-audit-rules-networkconfig-modification` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_rules_networkconfig_modification) |
