...
jira:
pr:
compare: compliance/4.21/m10-api-encryption
prev_group: M9
next_group: M11
---
...
| Check | Profile | Docs |
|-------|---------|------|
| `ocp4-cis-api-server-encryption-provider-cipher` | CIS | [📖](https://docs.openshift.com/container-platform/latest/security/encrypting-etcd.html) |
| `ocp4-e8-api-server-encryption-provider-cipher` | E8 | [📖](https://docs.openshift.com/container-platform/latest/security/encrypting-etcd.html) |
