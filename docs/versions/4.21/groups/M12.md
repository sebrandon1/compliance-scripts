...
jira:
pr:
compare: compliance/4.21/m12-audit-profile
prev_group: M11
next_group: L1
---
...
| Check | Profile | Docs |
|-------|---------|------|
| `ocp4-cis-audit-profile-set` | CIS | [📖](https://docs.openshift.com/container-platform/latest/security/audit-log-policy-config.html) |
