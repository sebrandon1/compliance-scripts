...
|-------|---------|-------------|------|
| `rhcos4-e8-worker-configure-crypto-policy` | E8 | Configure system crypto policy (worker) | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/system/software/integrity/crypto/configure_crypto_policy) |
| `rhcos4-e8-master-configure-crypto-policy` | E8 | Configure system crypto policy (master) | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/system/software/integrity/crypto/configure_crypto_policy) |
