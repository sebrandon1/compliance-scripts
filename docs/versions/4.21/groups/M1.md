...
This remediation applies comprehensive SSH daemon hardening settings to improve security posture. These settings are consolidated with [H3: SSHD Empty Passwords](H3.html) and [L1: SSHD LogLevel](L1.html) in a single MachineConfig.
...
These settings are part of the consolidated SSHD hardening MachineConfig:
...
|-------|---------|-------------|
| `rhcos4-e8-worker-sshd-disable-root-login` | E8 | Disable root SSH login |
| `rhcos4-e8-worker-sshd-disable-gssapi-auth` | E8 | Disable GSSAPI authentication |
| `rhcos4-e8-worker-sshd-disable-rhosts` | E8 | Disable rhosts authentication |
| `rhcos4-e8-worker-sshd-disable-user-known-hosts` | E8 | Ignore user known_hosts |
| `rhcos4-e8-worker-sshd-do-not-permit-user-env` | E8 | Block user environment |
| `rhcos4-e8-worker-sshd-enable-strictmodes` | E8 | Enable strict modes |
| `rhcos4-e8-worker-sshd-print-last-log` | E8 | Print last login |
...
- [L1: SSHD LogLevel](L1.html) - LOW severity
