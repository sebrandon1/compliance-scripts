...
| Check | Profile | Docs |
|-------|---------|------|
| `rhcos4-e8-worker-sysctl-kernel-dmesg-restrict` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/system/permissions/restrictions/sysctl_kernel_dmesg_restrict) |
| `rhcos4-e8-master-sysctl-kernel-dmesg-restrict` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/system/permissions/restrictions/sysctl_kernel_dmesg_restrict) |
