...
|-------|---------|-------------|------|
| `rhcos4-e8-worker-no-empty-passwords` | E8 | Prevent empty password authentication (worker) | [📖](https://static.open-scap.org/ssg-guides/ssg-rhcos4-guide-e8.html) |
| `rhcos4-e8-master-no-empty-passwords` | E8 | Prevent empty password authentication (master) | [📖](https://static.open-scap.org/ssg-guides/ssg-rhcos4-guide-e8.html) |
