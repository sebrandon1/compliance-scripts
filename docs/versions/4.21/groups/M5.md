...
| Check | Profile | Docs |
|-------|---------|------|
| `rhcos4-e8-worker-audit-rules-kernel-module-loading-delete` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_kernel_module_loading) |
| `rhcos4-e8-worker-audit-rules-kernel-module-loading-finit` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_kernel_module_loading) |
| `rhcos4-e8-worker-audit-rules-kernel-module-loading-init` | E8 | [📖](https://github.com/ComplianceAsCode/content/tree/master/linux_os/guide/auditing/auditd_configure_rules/audit_kernel_module_loading) |
