...
A comprehensive testing framework is available to validate that compliance remediations don't break your cluster.

```bash
# Navigate to testing directory
cd testing

# See available testing commands
make help

# Test high severity remediations
make test-high
```
...
- `testing/` — Testing framework scripts and documentation
- `test-runs/` — Test execution results (auto-generated, ignored by git)
